...
static const u1_t PROGMEM APPEUI[8]= DEFAULT_APPEUI;  //hs002
...
// ATTENTION the oder in bytes must be reversed defined (last byte form TTN is the first byte here)
 ...
 // this is for ttgo t-beam 1 device
static const u1_t PROGMEM DEVEUI[8]= DEFAULT_DEVEUI; // hs002
...
// this is for ttgo t-beam 2 device
static const u1_t PROGMEM APPKEY[16] = DEFAULT_APPKEY; // hs002
